...
public class Bishop extends Chessman {
    ...
    protected static final int NULL_PIN = 9;

    protected Bishop(ChessBoard b, int rank, int file,
                     boolean w) {
        super(b, rank, file, w);
        super.setChessSymbolInt(super.isWhite ? 0 : 1);
        super.setRelativeValue();
        initializeMoves();
    }

    protected void resetRestrictedMovesFlags() { pinnedDirection = NULL_PIN; }
    ...
    protected void findPsuedoLegalMoves() {
        ...
        boolean isCheck, isPinned; // 2nd terminal=king opp color -> isPinned is truely pinned
        numberOfMoves = 0;
        int[] direction = {-4, -3, 3, 4};
        //int rank, file;
